	...
	var datatableInit = function() {
		...
		$table.dataTable({
		  ...
		  aoColumns: [
	            ...
	            { "mData": "plannedTripTime","defaultContent":""},
	        	...
	        	$('.ccc').each(function(i){
	        		...
	        		$(this).on('click',function(e){
					    ...
					    $('#employe_id').val(recordid);
		        		   $.ajax({
		        			   url: $('body').attr('backend_url')+"/api/reports/v1/planassettriptime/one?id="+recordid,
		        			   method:"POST",
		        			   contentType: "application/json",
		        			   data:recordid,
		        			   success:function(data){
			                        ...
			                        $("#equipment_2").trigger('change');
			     				    ...
			     				    $("#section_2").trigger('change');
			  						...
			  						$("#plannedTripTime2").val(data.plannedTripTime); 
