...
<html class="fixed">
	<head>
		...
		<title>Плановые показателы длительности цикла горных работ</title>
	...
	<body backend_url="${backend_url}" >
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2><msg>planovayiepokasatelichiklagornixrabot</msg></h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span><msg>planovayiepokasatelichiklagornixrabot</msg></span></li>
							</ol>
						...
						<section class="panel">
							<header class="panel-heading">
							  <div class="row">
								...
								<h2 class="panel-title"><msg>planovayiepokasatelichiklagornixrabot</msg></h2>
							</header>
							<div class="panel-body">
								<table class="table table-bordered table-striped" id="datatable-ajax" data-url="${backend_url}/api/reports/v1/planassettriptime/data">
									 <thead>
										 <tr>
											<th><msg>date</msg></th>
												...
												<form id="demo-form" class="form-horizontal mb-lg" novalidate="novalidate">
												   ...
												   <div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<input type="number" name="plannedTripTime" class="form-control" id="plannedTripTime" placeholder="">
														</div>
												</form>
											</div>
											...
											<div class="panel-body">
												<form id="demo-form" class="form-horizontal mb-lg" novalidate="novalidate">
												   ...
												   <div class="form-group">
														<label class="col-sm-3 control-label"><msg>texnika</msg></label>
														<div class="col-sm-9">
															  <select id="equipment_2" name="equipment_3" data-plugin-selectTwo class="form-control populate">
													...
													<div class="form-group">
														<label class="col-sm-3 control-label"><msg>planovayachiklovgornixrabot</msg></label>
														<div class="col-sm-9">
															<input type="number" name="plannedTripTime2" class="form-control" id="plannedTripTime2" placeholder="">
														</div>
		...
		<!-- Examples -->
		<script src="/js/table/planned-duration-mining-cycle-table.js"></script>
		...
		$("#createbtn").on("click",function(){
		   var add = {
		      ...
		      "plannedTripTime":$("#plannedTripTime").val(),
		      
		   };
		   
		   
		   $.ajax({
			  url:'${backend_url}/api/reports/v1/planassettriptime/create',
			  method:'POST',
			  contentType: "application/json",
        ...
        $("#updatebtn").on('click',function(){
            var update = {
		      ...
		      "plannedTripTime":$("#plannedTripTime2").val(),
		   }
           
	           $.ajax({
				  url:'${backend_url}/api/reports/v1/planassettriptime/update',
				  method:'POST',
				  contentType: "application/json",
        ...
        $("#load").click(function(){
      	  window.location = '${backend_url}/api/reports/v1/planassettriptime/xlsx';
