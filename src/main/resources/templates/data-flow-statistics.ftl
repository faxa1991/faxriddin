...
<html class="fixed">
	<head>
		...
		<title>Статистика потока данных</title>
	...
	<body backend_url="${backend_url}">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Статистика потока данных</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Статистика потока данных</span></li>
					...
					<!-- start: page -->
						<section class="panel">
							...
							<div class="panel-body">
								     ...
								     <!--      <div class="col-sm-4">
										   	<div class="form-group col-sm-12">
												 <label class="control-label">Суммировать</label>
												  <select id="summarize" name="summarize" data-plugin-selectTwo class="form-control populate">
								                   <option></option>
								                   <option value="1">Суммировать по часам</option>
												   <option value="2">Суммировать по суткам</option> 
								...
								<table class="table table-bordered table-striped" id="datatable-ajax" data-url="${backend_url}/api/reports/v1/transfer-stat/data">
									 <thead>
										 <tr>
											<th >Дата</th>
											<th >Количество</th>
		...
		<!-- Examples -->
		<script src="/js/table/data-flow-statistics.js"></script>
